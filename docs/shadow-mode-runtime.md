...
`NO_GO` é obrigatório diante de incidente crítico, ausência de evidência, limites de qualidade falhos ou ausência de readiness/backup/rollback/relatório. Limiar é hipótese configurável; shadow não aprova piloto manual.
