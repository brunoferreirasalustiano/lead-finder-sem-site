...
const app = buildApp(db, { dailyLeadLimit: config.DAILY_LEAD_LIMIT,
  ...
  daily6GmailConfigDiagnostics: () => ({
    ...
    operatorEmailTestEnabled: config.OPERATOR_EMAIL_TEST_ENABLED,
    operatorEmailTestRecipientConfigured: Boolean(config.OPERATOR_EMAIL_TEST_RECIPIENT),
    operatorEmailTestSenderConfigured: Boolean(config.OPERATOR_EMAIL_TEST_SENDER),
    operatorEmailTestSenderMatch: config.OPERATOR_EMAIL_TEST_SENDER === 'leadfinderbrasil@gmail.com',
    operatorEmailTestClientIdConfigured: Boolean(config.OPERATOR_EMAIL_TEST_GOOGLE_CLIENT_ID),
    operatorEmailTestClientSecretConfigured: Boolean(config.OPERATOR_EMAIL_TEST_GOOGLE_CLIENT_SECRET),
    operatorEmailTestRefreshTokenConfigured: Boolean(config.OPERATOR_EMAIL_TEST_GOOGLE_REFRESH_TOKEN),
    operatorEmailTestFingerprintKeyConfigured: Boolean(config.OPERATOR_EMAIL_TEST_FINGERPRINT_KEY),
    ...
    realProviderConfigured: config.REAL_PROVIDER_CONFIGURED,
    realProvidersEnabled: config.REAL_PROVIDERS_ENABLED,
    collectionEgressEnabled: config.COLLECTION_EGRESS_ENABLED,
    enrichmentEgressEnabled: config.ENRICHMENT_EGRESS_ENABLED,
    hmlDaily6AuthEnabled: config.HML_DAILY6_AUTH_ENABLED,
    expectedOperationalShaConfigured: config.EXPECTED_OPERATIONAL_SHA !== undefined,
  }),
  daily6PilotEnabled: config.DAILY6_PILOT_ENABLED,
  discoveryAuthRequired: config.HML_DISCOVERY_AUTH_ENABLED,
  daily6AuthRequired: config.HML_DAILY6_AUTH_ENABLED,
  daily6OpportunityShadowEnabled: config.DAILY6_OPPORTUNITY_SHADOW_ENABLED,
