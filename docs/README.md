...
- [Console local de WhatsApp manual](runbooks/manual-whatsapp-operator-console.md) — preparação autenticada, botão `wa.me`, confirmação humana e execução somente em loopback.
