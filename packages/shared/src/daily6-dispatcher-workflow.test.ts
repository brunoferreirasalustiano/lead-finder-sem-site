...
describe('native Daily-6 scheduler authorization gate', () => {
  ...
  it('keeps Supabase as the only scheduler and preserves slot deadlines', () => {
    ...
    expect(workflow).toContain(
      'EXPECTED_OPERATIONAL_SHA: 8d8c2c7333bab3e95422644e1173e927a79136c7',
    );
...
describe('Daily-6 hosted runtime preflight workflow', () => {
  it('is manual-only, read-only, single-request and output-sanitized', async () => {
    ...
    expect(hosted).toContain('EXPECTED_OPERATIONAL_SHA: 8d8c2c7333bab3e95422644e1173e927a79136c7');
