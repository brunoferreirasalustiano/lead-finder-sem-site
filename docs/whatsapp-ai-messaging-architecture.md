...
- Credenciais, contatos completos e identidades operacionais nunca entram no Git, logs, evidências ou payloads de erro.
...
- aprovação humana final documentada fora de evidências públicas.
