...
-- Progressive Daily-6 selection needs a bounded discovery pool larger than the
-- legacy fixed ten-row window.  Cheap eligibility predicates remain in this
-- SECURITY DEFINER resolver; the application still evaluates at most fifteen
-- ranked finalists and stops at two approvals.
